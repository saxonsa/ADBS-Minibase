...
public class SumOperatorTest {
    ...
    @Test
    public void testSumOperatorQ4() throws IOException {
        Interpreter interpreter = new Interpreter("data/evaluation/input/sum_q4.txt", "data/evaluation/output/sum_q4.csv");
        interpreter.dump();
